        ...
        for linea in f:
            ...
            if linea.startswith("Estados="):
                ...
                if len(partes) == 3:
                    ...
                    print(f"Línea no reconocida en Conf2.txt: {linea}")

    return estados, alfabeto, transiciones, inicial, finales

def clasificar_simbolo(c):
    if c.isalpha():
        return "letra"
    elif c.isdigit():
        return "digito"
...
if __name__ == "__main__":
    estados, alfabeto, transiciones, inicial, finales = cargar_configuraciones_txt("Punto2/Conf2.txt")

    with open("Punto2/Cadenas2.txt", "r") as f:
        for linea in f:
            cadena = linea.strip()
